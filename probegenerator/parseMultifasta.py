...
def main():
    userInput = argparse.ArgumentParser(description="Requires a fasta file or multifasta file as input. If file is multifasta, the file is split "
    ...
    with open(inputFile) as file:
        ...
        return write_to_separate_fasta_files(fasta_entries)
