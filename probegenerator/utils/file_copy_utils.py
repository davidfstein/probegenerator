...
def main():
    ...
    requiredNamed.add_argument('-e', '--Extension', action='store', required=True)
    ...
    for initiator in initiators:
        copyfile(copy_file_name + extension, os.path.join('/data', 'output', initiator[0], copy_file_name, copy_file_name + extension))
